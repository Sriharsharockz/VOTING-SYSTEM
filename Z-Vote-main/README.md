...
[+] Create a .env file in the root directory for the api tokens
    [-] API_NINJA_API = 'yb2Qovprg0Js77gewSA1yA==pLMpK27xRUVBYqr9'
    [-] TWILIO_ACCOUNT_SID = 'AC9d9a421fec8f4adc61c5793c85fd6592'
    [-] TWILIO_AUTH_TOKEN = '9a5a700165ea5117f2e7930a5262b790'
    [-] TWILIO_PHONE_NUMBER = '+19382536236'
```
